...
In addition, this repository has almost the same overall architecture to the [CNVSRC2024Baseline](https://github.com/sectum1919/CNVSRC2024Baseline). The only difference is data, we added CN-CVS2 and CN-CVS2 dataset into the baseline training process. You can download these data on our [competition web](http://cnceleb.org/competition).
...
```
[Xiaolou Li](lixiaolou[at]cslt.org)
